...
@Table(name="electricity_Details")
...
public class Electricity {
    ...
    @JsonProperty("Current Reading")
    private String currReading;

    @Column(name="past_reading")
    @JsonProperty("Past Reading")
    private String pastReading;

    @Column(name="unit")
    @JsonProperty("Unit Used")
    ...
    @Column(name="month_left")
    @JsonProperty("Month Left")
